...
- ✅ First launch onboarding - automatically shows popover with welcome banner when no speaker is selected, guiding users to select their default speaker (PR #24) 